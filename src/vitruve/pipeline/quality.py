...
number may be printed; :func:`vitruve.measure.evaluate.evaluate` already does
...
class PoseEstimate:
    ...
    def _gated(value: float, sd: float) -> float:
        ...
        :func:`~vitruve.core.sensitivity.gated_pose` is the project-wide rule
...
class QualityReport:
    ...
    def subject_distance_m(self) -> float | None:
        """The value :func:`~vitruve.measure.evaluate.evaluate` expects."""
