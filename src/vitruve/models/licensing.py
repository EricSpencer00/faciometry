...
# ---------------------------------------------------------------------------
# The catalogue of backends Vitruve knows how to load.
# ---------------------------------------------------------------------------
...
SPIGA = Provenance(
    ...
    "The heatmaps are why this is the primary backend -- Vitruve needs "
...
MEDIAPIPE_FACE_LANDMARKER = Provenance(
    ...
    "assumption, not a measurement, so Vitruve ignores it",
)
...
STAR_LOSS = Provenance(
    ...
    "at all, so all rights are reserved and Vitruve will not load it",
)
