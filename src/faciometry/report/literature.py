...
DISCLAIMER = (
    ...
    "statement that anything about that person needs changing. Faciometry is not "
...
def contains_second_person(text: str) -> str | None:
    ...
    Faciometry writes about the measurement, never about the person holding the
...
class Association:
    ...
    #: :class:`~faciometry.derm.findings.FindingKind` value.
    target: str
    topic: str
    summary: str
