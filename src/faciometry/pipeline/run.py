...
The stages are deliberately dull. Every interesting decision in Faciometry lives
...
class NoFaceFound(RuntimeError):
    ...
    def __init__(self, view: View) -> None:
        super().__init__(
            f"no face was detected in the {view.value} photograph. Faciometry does not "
...
def analyze(
    ...
    *,
    ...
    optional, and Faciometry never infers them. An undeclared subject gets the
    ...
    :class:`~faciometry.pipeline.ingest.Ruler` is a physical reference of known
