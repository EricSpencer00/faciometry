...
into :func:`~faciometry.measure.evaluate.evaluate` after correcting would let every
...
class CanonicalFrame:
    ...
    :func:`~faciometry.measure.evaluate.evaluate` should be handed, and they follow
...
def to_canonical_frontal(
    ...
    *,
    ...
    :class:`~faciometry.core.formula.Axis` raise instead, so a depth-dependent
    ...
    :mod:`faciometry.core.scale` does not have to know this stage exists.
    """
