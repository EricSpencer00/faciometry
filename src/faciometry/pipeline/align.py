...
#: ArcFace five-point template at 112 pixels, in :data:`~faciometry.pipeline.ports.KEYPOINT_ORDER`.
...
class Similarity:
    ...
    Row-vector convention throughout, matching every other array in Faciometry:
