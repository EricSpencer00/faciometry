...
* **ACNE04** (Wu et al., roughly 1,457 images and 18,983 boxes, with Hayashi
  ...
  Faciometry will not ship weights trained on it.
...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(
        prog="python -m faciometry.derm.train",
        description=(
...
def check_licences(cfg: TrainConfig) -> list[str]:
    ...
    if licence in COMMERCIALLY_CLEAN_LICENCES:
        ...
        raise LicenseViolation(
            ...
            "faciometry/derm/train.py after reading the actual terms; this script will "
...
def model_card(
    ...
    return {
        "model": "faciometry acne lesion detector",
        "task": cfg.task,
