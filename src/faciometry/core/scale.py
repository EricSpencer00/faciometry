...
millimetre Faciometry prints descends from an assumption about the true size of
...
def from_interpupillary(
    ...
    *,
    ...
    ``declared_sex`` is used only if the subject stated it. Faciometry does not
    ...
    notes.append(
        "ancestry shifts the population mean by up to 12%, and Faciometry does not "
