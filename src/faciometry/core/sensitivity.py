...
If not, the number is noise wearing a decimal point, and Faciometry declines to
...
five-degree gate is therefore at the edge of what can be resolved, so Faciometry
